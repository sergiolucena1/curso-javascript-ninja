...
function showTeamPosition(position) {
    if (position < 1 || position > 5) { // || = ou 
        return 'Não temos a informação do time que está nessa posição.'
    }
    return 'O time que está em ' + position + 'º lugar é o ' + teams[position - 1] + '.' // invoquei o array diminuindo 1 
}
/*
...
function convertToHex(color) {
    switch (color) {
        ...
        case 'red':
            ...
            break
        case 'gold':
            console.log('O hexadecimal para a cor '+color+' é #FFD700.');
            break
        case 'OrangeRed':
            console.log('O hexadecimal para a cor '+color+' é #FF4500.')
            break
        default:
...
console.log(convertToHex('OrangeRed'))
