(function () {
    ...
    */
    function showOperationMessage ( operator , num1, num2){
        return console.log('A operação '+num1+' '+operator+' '+num2+' =')
    }
    console.log(showOperationMessage('+', 3 , 5))
    /*
    ...
    */
    ...
    var maisMais = calculator(operationSignal)
    if (maisMais){
        num1 = 3
        num2 = 113
        console.log(showOperationMessage(operationSignal, num1, num2), maisMais (num1, num2))
    }
    else{
        console.log(showErrorMessage(operationSignal))
    }
